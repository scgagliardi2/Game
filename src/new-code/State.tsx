import { BagPocket } from "./item/Item";
import { HELPCONTEXT } from "./misc/HelpSystem";
import { Pokemon } from "./pokemon/IPokemon";
import { Sprite } from "./sprite/ISprite";

export interface ISaveBlock1 {
    /*0x0000*/ pos: Coords16
...
export let EnemyParty: Pokemon[]

export let SaveBlock1: ISaveBlock1
...
export let HelpSystemContextId: HELPCONTEXT = HELPCONTEXT.NONE